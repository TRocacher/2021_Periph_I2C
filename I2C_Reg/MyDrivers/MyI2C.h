...
Les IO sont pris en charge par la lib, pas besoin de faire les configurations OD.
...
Vérifier alors la connectique physique SDA/SCL ainsi que l'alimentation du slave.
...
/**
  ...
  * @retval None
	* @Example MyI2C_PutString(I2C1,0, &MyI2C_SendTimeData);
  */
...
/**
  ...
  * @retval None
	* @Example	MyI2C_GetString(I2C1,0x0, &MyI2C_RecevievedTimeData);
  */
